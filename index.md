...
| [mosfet-switch-f5305s](components/actuator/mosfet-switch-f5305s/) | F5305S 隔離型 MOSFET 開關模組（HW-548） | actuator | GPIO, PWM | ❌ | ⏳ |
...
| [max31856](components/sensor/spi/max31856/) | MAX31856 高精度熱電偶數位轉換器（含線性化） | sensor/spi | SPI | ✅ | ⏳ |
